...
class BurstDecompilationReport
{
    ...
    public static void DumpBurstInspectorReportToFolder(string outputFolder)
    {
        ...
        try
        {
            ...
            var isSupportedProperty = burstCompileTargetType.GetProperty("IsSupported");
            ...
            var targets = (IEnumerable<object>)findExecuteMethodsMethod.Invoke(null, new object[] { AssembliesType.Editor });
